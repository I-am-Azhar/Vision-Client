        ...
        <div className="space-y-6 lg:space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {benefits.slice(0, 3).map((benefit, index) => (
              <ScrollFade key={index} delay={index * 0.1}>
                <div className="h-[120px] lg:h-[280px]">
              <GlareHover
                width="100%"
                height="100%"
              ...
              >
                <div className="flex flex-row lg:flex-col items-center justify-start lg:justify-center h-full p-4 md:p-6 lg:p-8 gap-3 md:gap-0 md:space-y-4">
                  {/* Icon - Left on mobile, top on desktop */}
                  <div className="w-16 h-16 md:w-24 md:h-24 lg:w-28 lg:h-28 flex items-center justify-center flex-shrink-0 lg:mx-auto">
                    <img
                      src={benefit.icon}
                      alt={benefit.title}
                  ...
                  {/* Title - Right on mobile, bottom on desktop */}
                  <h3 className="text-left lg:text-center text-base md:text-lg lg:text-xl xl:text-2xl font-semibold text-white flex-1 lg:flex-none">
                    {benefit.title}
                  </h3>
                </div>
              </GlareHover>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 max-w-5xl mx-auto">
            {benefits.slice(3, 5).map((benefit, index) => (
              <ScrollFade key={index + 3} delay={index * 0.1}>
                <div className="h-[120px] lg:h-[280px]">
              <GlareHover
                width="100%"
                height="100%"
              ...
              >
                <div className="flex flex-row lg:flex-col items-center justify-start lg:justify-center h-full p-4 md:p-6 lg:p-8 gap-3 md:gap-0 md:space-y-4">
                  {/* Icons - Left on mobile, top on desktop */}
                  {benefit.isDual ? (
                    <div className="flex flex-row items-center justify-center gap-1 md:gap-2 lg:gap-4 flex-shrink-0">
                      <div className="w-16 h-16 md:w-24 md:h-24 lg:w-28 lg:h-32 flex items-center justify-center">
                        <img
                          src={benefit.icon}
